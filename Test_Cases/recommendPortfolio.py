...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        ### Validate the age which it should be between 0 and 65
        
        if age is not None:
            age = parse_int(age)
            if age is not RANGE(0,65):
        ...
        if investment_amount is not None:
            ...
            if investment_amount < 5000:
                return build_validation_result(
                    False,
                    "investmentAmount",
                    "the investment amount should be 5,000 or more",
                )
    ...
    if risk_level == "None":
        initial_recommendation = "100% bonds (AAG), 0% equities (SPY)"
